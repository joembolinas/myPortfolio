...
export const learningJourney: LearningJourneyItem[] = [
  {
    ...
    expandedContent: {
      overview: 'Developed comprehensive administrative and procurement expertise while managing complex projects and stakeholder relationships in a fast-paced government environment.',
      keyLearnings: [
  ...
  },
  {
    ...
    expandedContent: {
      overview: 'Returned to formal education to build strong theoretical foundations in computer science while applying real-world experience to academic learning.',
      keyLearnings: [
      ...
      technologies: [
        'Java', 'Python', 'SQL', 'HTML/CSS', 'JavaScript basics'
      ],
      achievements: [
  ...
  },
  {
    ...
    period: '2024-Present',
    category: 'skill',
    description: 'Developing algorithmic thinking and problem-solving skills through consistent practice.',
    expandedContent: {
      overview: 'Committed to daily problem-solving practice to strengthen algorithmic thinking and prepare for technical interviews while building confidence in coding abilities.',
      keyLearnings: [
      ...
      technologies: [
        'Python for algorithms', 'Java for data structures', 'Problem-solving patterns'
      ],
      achievements: [
  ...
  },
  {
    ...
    expandedContent: {
      overview: 'Developing cybersecurity awareness and technical skills through hands-on labs and security challenges, building a well-rounded tech skill set.',
      keyLearnings: [
      ...
      technologies: [
        'Linux/Unix systems', 'Network tools (Nmap, Wireshark)', 'Security frameworks', 'Virtual machines'
      ],
      achievements: [
  ...
  },
  {
    ...
    expandedContent: {
      overview: 'Transitioning from traditional programming concepts to modern web development, focusing on creating interactive and responsive user experiences.',
      keyLearnings: [
      ...
      technologies: [
        'HTML5', 'CSS3', 'JavaScript ES6+', 'React', 'Tailwind CSS', 'Git/GitHub'
      ],
      achievements: [
  ...
  },
  {
    ...
    expandedContent: {
      overview: 'Developing a professional portfolio that demonstrates technical skills while telling the story of career transition from administration to technology.',
      keyLearnings: [
      ...
      technologies: [
        'React', 'TypeScript', 'Tailwind CSS', 'Framer Motion', 'Vite', 'GitHub Actions'
      ],
      achievements: [
  ...
  },
  {
    ...
    expandedContent: {
      overview: 'Using roadmap.sh to ensure comprehensive coverage of essential web development concepts and maintain a structured approach to skill building.',
      keyLearnings: [
      ...
      technologies: [
        'Frontend roadmap tools', 'Backend fundamentals', 'DevOps basics', 'Database concepts'
      ],
      achievements: [
  ...
  },
  {
    ...
    expandedContent: {
      overview: 'Developing proficiency in Git version control and GitHub collaboration features essential for professional software development teams.',
      keyLearnings: [
      ...
      technologies: [
        'Git CLI', 'GitHub', 'GitHub Actions', 'Markdown documentation'
      ],
      achievements: [
  ...
  },
  {
    ...
    expandedContent: {
      overview: 'Learning TypeScript to improve code quality, catch errors early, and work with modern enterprise-level JavaScript applications.',
      keyLearnings: [
      ...
      technologies: [
        'TypeScript', 'TSConfig optimization', 'Type definition files', 'ESLint integration'
      ],
      achievements: [
  ...
  },
  {
    ...
    expandedContent: {
      overview: 'Combining technical skills with administrative experience to prepare for remote opportunities that value both technical capability and strong organizational skills.',
      keyLearnings: [
      ...
      technologies: [
        'Communication tools', 'Project management platforms', 'Remote collaboration software'
      ],
      achievements: [
  ...
  },
  {
    ...
    expandedContent: {
      overview: 'Maintaining a growth mindset and systematic approach to learning new technologies and improving existing skills in the rapidly evolving tech landscape.',
      keyLearnings: [
  ...
  },
  {
    ...
    expandedContent: {
      overview: 'Strategic learning plan focused on becoming a well-rounded developer capable of contributing to complex projects and eventually mentoring others.',
      keyLearnings: [
      ...
      technologies: [
        'Node.js', 'Python/Django', 'PostgreSQL', 'AWS/Azure', 'Docker', 'Kubernetes'
      ],
      nextSteps: [
