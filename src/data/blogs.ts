...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: 'The challenges, learnings, and mindset shifts involved in transitioning from government administration to software development.',
  ...
  },
  {
    ...
    excerpt: 'Technical challenges and design decisions involved in creating a modern portfolio website with React and TypeScript.',
  ...
  },
  {
    ...
    excerpt: 'How to approach algorithmic problem-solving when coming from a non-technical background.',
  ...
  },
  {
    ...
    excerpt: 'Discovering the unexpected value of administrative experience in software development teams.',
  ...
  },
  {
    ...
    excerpt: 'The benefits, challenges, and practical steps involved in adopting TypeScript for better code quality.',
  ...
  },
  {
    ...
    excerpt: 'Communication, time management, and professional skills essential for successful remote work in tech.',
  ...
  },
  {
    ...
    excerpt: 'Best practices for version control, documentation, and project management using GitHub.',
