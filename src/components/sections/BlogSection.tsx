        ...
        <FadeInOnScroll>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              ...
              Writing helps me reflect on progress and hopefully helps others on similar paths.
            </p>
            ...
            <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-sm border border-gray-600/50 rounded-xl p-6 max-w-2xl mx-auto">
              ...
              <p className="text-gray-300 text-sm">
                I'm actively working on creating valuable content that documents my learning journey, 
                technical tutorials, and career transition insights. Each post will be thoroughly researched 
                and written to provide real value to fellow learners and career changers.
              </p>
            </div>
          </div>
        </FadeInOnScroll>
        ...
        {filteredPosts.length === 0 && (
          <FadeInOnScroll>
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-gray-400 mb-2">No posts in this category yet</h3>
        ...
        <FadeInOnScroll delay={0.4} className="text-center mt-16">
          <div className="bg-gradient-to-r from-gray-800/60 to-gray-700/60 backdrop-blur-sm border border-gray-600/50 rounded-xl p-8 max-w-3xl mx-auto">
            ...
            <p className="text-gray-300 mb-6">
              Want to be notified when I publish new content? Follow my journey on GitHub 
              or connect with me on LinkedIn for updates on new posts, projects, and insights.
            </p>
