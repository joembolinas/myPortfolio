import { r as Bi, g as ki } from './vendor-DavUf6mE.js';
var y = Bi();
const us = ki(y),
  hs = y.createContext({ transformPagePoint: (t) => t, isStatic: !1, reducedMotion: 'never' }),
  Qt = y.createContext({}),
  Jt = y.createContext(null),
  te = typeof document < 'u',
  Fe = te ? y.useLayoutEffect : y.useEffect,
  fs = y.createContext({ strict: !1 }),
...
function Oi(t, e, n, s) {
  const { visualElement: i } = y.useContext(Qt),
    o = y.useContext(fs),
    r = y.useContext(Jt),
    a = y.useContext(hs).reducedMotion,
    c = y.useRef();
  ((s = s || o.renderer),
    !c.current &&
      s &&
  ...
  const u = y.useRef(!!(n[ds] && !window.HandoffComplete));
  return (
    Fe(() => {
...
function Ui(t, e) {
  if (ne(t)) {
    ...
    return { initial: n === !1 || Rt(n) ? n : void 0, animate: Rt(s) ? s : void 0 };
  }
  return t.inherit !== !1 ? e : {};
}
function Ni(t) {
  const { initial: e, animate: n } = Ui(t, y.useContext(Qt));
...
const cn = {
  ...
  Lt = {};
for (const t in cn) Lt[t] = { isEnabled: (e) => cn[t].some((n) => !!e[n]) };
function Wi(t) {
  for (const e in t) Lt[e] = { ...Lt[e], ...t[e] };
}
const Oe = y.createContext({}),
  ps = y.createContext({}),
  Gi = Symbol.for('motionComponentSymbol');
function Hi({
  preloadedFeatures: t,
  ...
  function o(a, c) {
    let l;
    const u = { ...y.useContext(hs), ...a, layoutId: $i(a) },
      { isStatic: h } = u,
      f = Ni(a),
      d = s(a, h);
    if (!h && te) {
      f.visualElement = Oi(i, d, u, e);
      const m = y.useContext(ps),
        p = y.useContext(fs).strict;
      f.visualElement && (l = f.visualElement.loadFeatures(u, p, t, m));
    }
    return y.createElement(
      Qt.Provider,
      { value: f },
      l && f.visualElement ? y.createElement(l, { visualElement: f.visualElement, ...u }) : null,
      n(i, a, Ii(d, f.visualElement, c), d, h, f.visualElement),
    );
  }
...
function Ie(t) {
  return typeof t != 'string' || t.includes('-') ? !1 : !!(Ki.indexOf(t) > -1 || /[A-Z]/.test(t));
}
const $t = {};
function _i(t) {
  Object.assign($t, t);
...
function gs(t, { layout: e, layoutId: n }) {
  return (
    lt.has(t) || t.startsWith('origin') || ((e || n !== void 0) && (!!$t[t] || t === 'opacity'))
  );
}
const O = (t) => !!(t && t.getVelocity),
  Xi = { x: 'translateX', y: 'translateY', z: 'translateZ', transformPerspective: 'perspective' },
  Yi = Ft.length;
...
const ys = (t) => (e) => typeof e == 'string' && e.startsWith(t),
  ...
  J = (t, e, n) => Math.min(Math.max(n, t), e),
  ut = { test: (t) => typeof t == 'number', parse: parseFloat, transform: (t) => t },
  At = { ...ut, transform: (t) => J(0, 1, t) },
  It = { ...ut, default: 1 },
...
const kt = (t) => ({
  ...
  tr = kt('vh'),
  er = kt('vw'),
  ln = { ...H, parse: (t) => H.parse(t) / 100, transform: (t) => H.transform(t * 100) },
...
function Ue(t, e, n, s) {
  ...
  if (
    (e.transform ||
      (c || s ? (i.transform = qi(t.transform, n, u, s)) : i.transform && (i.transform = 'none')),
    l)
  ) {
...
function nr({ transformTemplate: t }, e, n) {
  return y.useMemo(() => {
    const s = Ne();
    return (Ue(s, e, { enableHardwareAcceleration: !n }, t), Object.assign({}, s.vars, s.style));
  }, [e]);
}
function sr(t, e, n) {
  const s = t.style || {},
    i = {};
  return (Ts(i, s, t), Object.assign(i, nr(t, e, n)), t.transformValues ? t.transformValues(i) : i);
}
function ir(t, e, n) {
  const s = {},
    i = sr(t, e, n);
...
let bs = (t) => !zt(t);
function or(t) {
  t && (bs = (e) => (e.startsWith('on') ? !zt(e) : t(e)));
}
try {
...
function We(
  ...
  (d.transform && (p && (m.transform = d.transform), delete d.transform),
    p &&
      ...
      (m.transformOrigin = cr(p, i !== void 0 ? i : 0.5, o !== void 0 ? o : 0.5)),
    e !== void 0 && (d.x = e),
    n !== void 0 && (d.y = n),
    s !== void 0 && (d.scale = s),
    r !== void 0 && hr(d, r, a, c, !1));
}
const Vs = () => ({ ...Ne(), attrs: {} }),
...
function dr(t = !1) {
  return (n, s, i, { latestValues: o }, r) => {
    const c = (Ie(n) ? fr : ir)(s, o, r, n),
      u = { ...ar(s, typeof n == 'string', t), ...c, ref: i },
      { children: h } = s,
...
function As(t, e, n, s) {
  Ss(t, e, void 0, s);
  for (const i in e.attrs) t.setAttribute(Cs.has(i) ? i : Be(i), e.attrs[i]);
}
function He(t, e) {
  const { style: n } = t,
    s = {};
  for (const i in n) (O(n[i]) || (e.style && O(e.style[i])) || gs(i, t)) && (s[i] = n[i]);
  return s;
}
function ws(t, e) {
  const n = He(t, e);
  for (const s in t)
    if (O(t[s]) || O(e[s])) {
      const i = Ft.indexOf(s) !== -1 ? 'attr' + s.charAt(0).toUpperCase() + s.substring(1) : s;
      n[i] = t[s];
    }
  return n;
}
...
const Kt = (t) => Array.isArray(t),
  mr = (t) => !!(t && typeof t == 'object' && t.mix && t.toValue),
  pr = (t) => (Kt(t) ? t[t.length - 1] || 0 : t);
function Gt(t) {
  const e = O(t) ? t.get() : t;
  return mr(e) ? e.toValue() : e;
}
function gr({ scrapeMotionValuesFromProps: t, createRenderState: e, onMount: n }, s, i, o) {
...
function Pr(t, e) {
  ...
  const i = { delta: 0, timestamp: 0, isProcessing: !1 },
    o = Ut.reduce((h, f) => ((h[f] = vr(() => (n = !0))), h), {}),
    r = (h) => o[h].process(i),
    a = () => {
      const h = performance.now();
      ((n = !1),
        (i.delta = s ? 1e3 / 60 : Math.max(Math.min(h - i.timestamp, xr), 1)),
        (i.timestamp = h),
        (i.isProcessing = !0),
        Ut.forEach(r),
        (i.isProcessing = !1),
...
const {
    ...
    state: B,
    steps: ae,
  } = Pr(typeof requestAnimationFrame < 'u' ? requestAnimationFrame : L, !0),
  Tr = {
    useVisualState: Ms({
      ...
      onMount: (t, e, { renderState: n, latestValues: s }) => {
        (A.read(() => {
          ...
          A.render(() => {
            (We(n, s, { enableHardwareAcceleration: !1 }, Ge(e.tagName), t.transformTemplate),
              As(e, n));
          }));
      },
    }),
  },
  br = { useVisualState: Ms({ scrapeMotionValuesFromProps: He, createRenderState: Ne }) };
...
const Sr = (t) => (e) => Rs(e) && t(e, ie(e));
function K(t, e, n, s) {
  return z(t, e, Sr(n), s);
}
const Cr = (t, e) => (n) => e(t(n)),
  Q = (...t) => t.reduce(Cr);
function Ls(t) {
  let e = null;
  return () => {
...
function pn(t, e) {
  const n = 'pointer' + (e ? 'enter' : 'leave'),
    ...
    i = (o, r) => {
      if (o.pointerType === 'touch' || Fs()) return;
      const a = t.getProps();
...
const Bs = (t, e) => (e ? (t === e ? !0 : Bs(t, e.parentElement)) : !1);
function ce(t, e) {
  if (!e) return;
...
class Dr extends et {
    ...
    (super(...arguments),
        ...
        const s = this.node.getProps(),
          o = K(
            ...
            (a, c) => {
              ...
              const { onTap: l, onTapCancel: u, globalTapTarget: h } = this.node.getProps();
              A.update(() => {
                !h && !Bs(this.node.current, a.target) ? u && u(a, c) : l && l(a, c);
              });
            },
      ...
      (this.startAccessiblePress = () => {
        const e = (o) => {
          ...
          s = () => {
            this.isPressing && ce('cancel', (o, r) => this.cancelPress(o, r));
          },
  ...
  mount() {
    const e = this.node.getProps(),
      n = K(e.globalTapTarget ? window : this.node.current, 'pointerdown', this.startPointerPress, {
...
function Lr({ root: t, ...e }) {
  const n = t || document;
  le.has(n) || le.set(n, {});
  const s = le.get(n),
    i = JSON.stringify(e);
  return (s[i] || (s[i] = new IntersectionObserver(Rr, { root: t, ...e })), s[i]);
}
function Er(t, e, n) {
  const s = Lr(e);
  return (
...
class Br extends et {
  ...
  startObserver() {
    ...
    return Er(this.node.current, r, a);
  }
  mount() {
    this.startObserver();
  }
  update() {
    ...
    ['amount', 'margin', 'root'].some(kr(e, n)) && this.startObserver();
  }
  unmount() {}
}
function kr({ viewport: t = {} }, { viewport: e = {} } = {}) {
  return (n) => t[n] !== e[n];
}
const jr = {
  inView: { Feature: Br },
...
function re(t, e, n) {
  const s = t.getProps();
  return $e(s, e, n !== void 0 ? n : s.custom, Or(t), Ir(t));
}
let ze = L;
const ct = (t) => t * 1e3,
  _ = (t) => t / 1e3,
...
function Os(t) {
  return !!(!t || (typeof t == 'string' && Is[t]) || js(t) || (Array.isArray(t) && t.every(Os)));
}
...
function Us(t) {
  if (t) return js(t) ? Ct(t) : Array.isArray(t) ? t.map(Us) : Is[t];
}
function Nr(
  t,
  e,
...
const zr = jt(0.42, 0, 1, 1),
  ...
  Gs = (t) => (e) => (e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2),
  Hs = (t) => (e) => 1 - t(1 - e),
  Ke = (t) => 1 - Math.sin(Math.acos(t)),
  $s = Hs(Ke),
  Xr = Gs(Ke),
  zs = jt(0.33, 1.53, 0.69, 0.99),
  _e = Hs(zs),
  Yr = Gs(_e),
  qr = (t) => ((t *= 2) < 1 ? 0.5 * _e(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1)))),
  Zr = {
    linear: L,
    easeIn: zr,
    easeInOut: Ws,
...
const be = { test: Xe('#'), parse: Jr, transform: at.transform },
  pt = {
    test: Xe('hsl', 'hue'),
  ...
  j = {
    test: (t) => at.test(t) || be.test(t) || pt.test(t),
    parse: (t) => (at.test(t) ? at.parse(t) : pt.test(t) ? pt.parse(t) : be.parse(t)),
    transform: (t) => (Bt(t) ? t : t.hasOwnProperty('red') ? at.transform(t) : pt.transform(t)),
  },
  R = (t, e, n) => -n * t + n * e + t;
function he(t, e, n) {
  return (
...
function to({ hue: t, saturation: e, lightness: n, alpha: s }) {
  ...
  if (!e) i = o = r = n;
    ...
    const a = n < 0.5 ? n * (1 + e) : n + e - n * e,
      c = 2 * n - a;
    ((i = he(c, a, t + 1 / 3)), (o = he(c, a, t)), (r = he(c, a, t - 1 / 3)));
  }
  return {
...
const Xs = { regex: Zi, countKey: 'Vars', token: '${v}', parse: L },
  Ys = { regex: xs, countKey: 'Colors', token: '${c}', parse: j.parse },
  qs = { regex: se, countKey: 'Numbers', token: '${n}', parse: ut.parse };
...
function _t(t) {
  ...
  return (n.value.includes('var(--') && de(n, Xs), de(n, Ys), de(n, qs), n);
}
function Zs(t) {
  return _t(t).values;
}
function Qs(t) {
  ...
  return (r) => {
    ...
    for (let c = 0; c < o; c++)
      c < s
        ? (a = a.replace(Xs.token, r[c]))
        : c < s + n
          ? (a = a.replace(Ys.token, j.transform(r[c])))
          : (a = a.replace(qs.token, wt(r[c])));
    return a;
  };
}
...
function ro(t) {
  const e = Zs(t);
  return Qs(t)(e.map(io));
}
const tt = { test: so, parse: Zs, createTransformer: Qs, getAnimatableNone: ro },
  Js = (t, e) => (n) => `${n > 0 ? e : t}`;
function ti(t, e) {
...
const ei = (t, e) => {
  ...
  oo = (t, e) => {
    const n = { ...t, ...e },
      s = {};
    for (const i in n) t[i] !== void 0 && e[i] !== void 0 && (s[i] = ti(t[i], e[i]));
    return (i) => {
...
function si(t, e, { clamp: n = !0, ease: s, mixer: i } = {}) {
  const o = t.length;
  ...
  const r = co(e, s, i),
    ...
    c = (l) => {
      ...
      const h = Et(t[u], t[u + 1], l);
      return r[u](h);
    };
  return n ? (l) => c(J(t[0], t[o - 1], l)) : c;
}
function lo(t, e) {
...
function Xt({ duration: t = 300, keyframes: e, times: n, ease: s = 'easeInOut' }) {
  const i = _r(s) ? s.map(gn) : gn(s),
    ...
    a = si(r, e, { ease: Array.isArray(i) ? i : fo(e, i) });
...
const me = 0.001,
  ...
  yo = 0.05,
  vo = 1;
function xo({ duration: t = 800, bounce: e = 0.25, velocity: n = 0, mass: s = 1 }) {
  let i,
    o,
    r = 1 - e;
  ((r = J(yo, vo, r)),
  ...
  const a = 5 / t,
    c = To(i, o, a);
  if (((t = ct(t)), isNaN(c))) return { stiffness: 100, damping: 10, duration: t };
  {
...
function oi({ keyframes: t, restDelta: e, restSpeed: n, ...s }) {
  const i = t[0],
    o = t[t.length - 1],
    r = { done: !1, value: i },
    {
  ...
  if (m < 1) {
    ...
    v = (P) => {
      ...
      return o - V * (((d + m * x * p) / g) * Math.sin(g * P) + p * Math.cos(g * P));
    };
    ...
    v = (P) => {
      const V = Math.exp(-m * x * P),
        w = Math.min(g * P, 300);
      return o - (V * ((d + m * x * p) * Math.sinh(w) + g * p * Math.cosh(w))) / g;
    };
  }
  return {
...
function Pn({
  ...
  const v = (S) => -p * Math.exp(-S / s),
    ...
    P = (S) => {
      const C = v(S),
        U = g(S);
      ((f.done = Math.abs(C) <= l), (f.value = f.done ? T : U));
    };
  let V, w;
  const D = (S) => {
    d(f.value) &&
...
function bn(t) {
  ...
  const n = 50;
  let s = t.next(e);
  for (; !s.done && e < Tn; ) ((e += n), (s = t.next(e)));
  return e >= Tn ? 1 / 0 : e;
}
const Ao = { decay: Pn, inertia: Pn, tween: Xt, keyframes: Xt, spring: oi };
function Yt({
  autoplay: t = !0,
  delay: e = 0,
  driver: n = Co,
  ...
  const g = Ao[i] || Xt;
  let P;
  g !== Xt && typeof s[0] != 'number' && ((P = si([0, 100], s, { clamp: !1 })), (s = [0, 100]));
  const V = g({ ...f, keyframes: s });
  let w;
  a === 'mirror' && (w = g({ ...f, keyframes: [...s].reverse(), velocity: -(f.velocity || 0) }));
  let D = 'idle',
    S = null,
    C = null,
    U = null;
  V.calculatedDuration === null && o && (V.calculatedDuration = bn(V));
  ...
  const ft = (M) => {
      ...
      if (o) {
        ...
        (!nt && oe >= 1 && (nt = 1),
          ...
          (Ot = Math.min(Ot, o + 1)),
          !!(Ot % 2) &&
            (a === 'reverse' ? ((nt = 1 - nt), r && (nt -= r / G)) : a === 'mirror' && (rn = w)),
          (sn = J(0, 1, nt) * G));
      }
      ...
      const Fi = S === null && (D === 'finished' || (D === 'running' && on));
      return (h && h(bt.value), Fi && Pt(), bt);
    },
    F = () => {
      (v && v.stop(), (v = void 0));
    },
  ...
  const en = {
    ...
    set time(M) {
      ((M = ct(M)), (k = M), S !== null || !v || d === 0 ? (S = M) : (C = v.now() - M / d));
    },
    get duration() {
      const M = V.calculatedDuration === null ? bn(V) : V.calculatedDuration;
      return _(M);
    },
    get speed() {
      return d;
...
const Do = wo(() => Object.hasOwnProperty.call(Element.prototype, 'animate')),
  Mo = new Set(['opacity', 'clipPath', 'filter', 'transform', 'backgroundColor']),
  Nt = 10,
  Ro = 2e4,
  Lo = (t, e) => e.type === 'spring' || t === 'backgroundColor' || !Os(e.ease);
function Eo(t, e, { onUpdate: n, onComplete: s, ...i }) {
  if (
    !(
      Do() &&
      Mo.has(e) &&
  ...
  if (Lo(e, i)) {
    ...
    const V = [];
    let w = 0;
    for (; !P.done && w < Ro; ) ((P = g.sample(w)), V.push(P.value), (w += Nt));
...
function Fo({ keyframes: t, delay: e, onUpdate: n, onComplete: s }) {
  const i = () => (
    n && n(t[t.length - 1]),
    s && s(),
    {
  ...
  return e ? Yt({ keyframes: [0, 1], duration: 0, delay: e, onComplete: i }) : i();
}
const Bo = { type: 'spring', stiffness: 500, damping: 25, restSpeed: 10 },
  ...
  jo = { type: 'keyframes', duration: 0.8 },
  Oo = { type: 'keyframes', ease: [0.25, 0.1, 0.35, 1], duration: 0.3 },
  Io = (t, { keyframes: e }) =>
    e.length > 2 ? jo : lt.has(t) ? (t.startsWith('scale') ? ko(e[1]) : Bo) : Oo,
  Se = (t, e) =>
    t === 'zIndex'
      ? !1
      : !!(
          typeof e == 'number' ||
          Array.isArray(e) ||
          (typeof e == 'string' && (tt.test(e) || e === '0') && !e.startsWith('url('))
        ),
...
function ai(t, e) {
  let n = Ye(t);
  return (n !== Ce && (n = tt), n.getAnimatableNone ? n.getAnimatableNone(e) : void 0);
}
  ...
  Ze =
    ...
    (i) => {
      ...
      if (
        ...
        !h || !f || Ur.current || o.type === !1 || Ko.skipAnimations)
      )
        return Fo(d);
      if (
        !s.isHandoff &&
...
class Xo {
  constructor(e, n = {}) {
    ((this.version = '10.18.0'),
      ...
      (this.canTrackVelocity = _o(this.current)),
      (this.owner = n.owner));
  }
  onChange(e) {
...
const ui = (t) => (e) => e.test(t),
  Yo = { test: (t) => t === 'auto', parse: (t) => t },
  hi = [ut, b, H, q, er, tr, Yo],
  Vt = (t) => hi.find(ui(t)),
  qo = [...hi, j, tt],
  Zo = (t) => qo.find(ui(t));
function Qo(t, e, n) {
        ...
        u === null &&
          (u =
            (i = (s = n[c]) !== null && s !== void 0 ? s : t.readValue(c)) !== null && i !== void 0
              ...
              : e[c]),
        u != null &&
          (typeof u == 'string' && (li(u) || ci(u))
            ? (u = parseFloat(u))
            : !Zo(u) && tt.test(l) && (u = ai(c, l)),
...
function fi(t, e, { delay: n = 0, transitionOverride: s, type: i } = {}) {
  ...
  for (const h in a) {
    ...
    if (
      ...
      continue;
    f.start(Ze(h, f, d, t.shouldReduceMotion && lt.has(h) ? { type: !1 } : m));
    const x = f.animation;
    (qt(c) && (c.add(h), x.then(() => c.remove(h))), l.push(x));
  }
  return (
    r &&
      Promise.all(l).then(() => {
    ...
    Array.from(t.variantChildren)
      ...
      .forEach((l, u) => {
        (l.notify('AnimationStart', e),
          r.push(Ae(l, e, { ...o, delay: n + c(u) }).then(() => l.notify('AnimationComplete', e))));
      }),
    Promise.all(r)
  );
}
...
const ca = [...ke].reverse(),
  la = ke.length;
function ua(t) {
  return (e) => Promise.all(e.map(({ animation: n, options: s }) => aa(t, n, s)));
}
function ha(t) {
  let e = ua(t);
  const n = da();
  ...
  function r(c, l) {
    ...
    for (let T = 0; T < la; T++) {
      ...
      if (
        ...
        (g.protectedKeys = { ...m }),
        (!g.isActive && w === null) || (!P && !g.prevProp) || ee(P) || typeof P == 'boolean')
      )
        continue;
      let C = fa(g.prevProp, P) || (v === l && g.isActive && !D && V) || (T > p && V),
        U = !1;
      ...
      const { prevResolvedValues: $ = {} } = g,
        k = { ...$, ...G },
        ft = (F) => {
          ((C = !0), d.has(F) && ((U = !0), d.delete(F)), (g.needsAnimating[F] = !0));
        };
      for (const F in k) {
        const Y = G[F],
          Pt = $[F];
      ...
      ((g.prevProp = P),
        ...
        C && (!D || U) && f.push(...ht.map((F) => ({ animation: F, options: { type: v, ...c } }))));
    }
    if (d.size) {
      const T = {};
      (d.forEach((v) => {
    ...
    if (
      ...
      (this.updatePoint = () => {
        ...
        const h = ge(this.lastMoveEventInfo, this.history),
          ...
          d = va(h.offset, { x: 0, y: 0 }) >= 3;
        if (!f && !d) return;
        const { point: m } = h,
          { timestamp: p } = B;
        this.history.push({ ...m, timestamp: p });
        const { onStart: x, onMove: T } = this.handlers;
        (f || (x && x(this.lastMoveEvent, h), (this.startEvent = this.lastMoveEvent)),
      ...
      (this.handlePointerUp = (h, f) => {
        ...
        if ((this.dragSnapToOrigin && p && p(), !(this.lastMoveEvent && this.lastMoveEventInfo)))
          return;
        const x = ge(
          h.type === 'pointercancel' ? this.lastMoveEventInfo : pe(f, this.transformPagePoint),
          this.history,
        );
...
function ge({ point: t }, e) {
  return { point: t, delta: Sn(t, mi(e)), offset: Sn(t, xa(e)), velocity: Pa(e, 0.1) };
}
function xa(t) {
  return t[0];
}
...
function Pa(t, e) {
  ...
  let n = t.length - 1,
    s = null;
  const i = mi(t);
  for (; n >= 0 && ((s = t[n]), !(i.timestamp - s.timestamp > ct(e))); ) n--;
  if (!s) return { x: 0, y: 0 };
...
function Dt(t, e, n, s) {
  (Cn(t.x, e.x, n.x, s ? s.originX : void 0), Cn(t.y, e.y, n.y, s ? s.originY : void 0));
}
function An(t, e, n) {
...
function Va(t, { top: e, left: n, bottom: s, right: i }) {
  return { x: Dn(t.x, n, i), y: Dn(t.y, e, s) };
}
function Mn(t, e) {
  let n = e.min - t.min,
    s = e.max - t.max;
...
function Rn(t, e, n) {
  return { min: Ln(t, e), max: Ln(t, n) };
}
function Ln(t, e) {
  return typeof t == 'number' ? t : t[e] || 0;
}
const En = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 }),
  gt = () => ({ x: En(), y: En() }),
  Fn = () => ({ min: 0, max: 0 }),
  E = () => ({ x: Fn(), y: Fn() });
function W(t) {
...
function it(t) {
  return Me(t) || gi(t) || t.z || t.rotate || t.rotateX || t.rotateY;
}
function gi(t) {
...
function Ra(t, e, n, s = !1) {
  ...
  for (let a = 0; a < i; a++) {
    ...
    (c && c.style && c.style.display === 'contents') ||
      ...
      r && ((e.x *= r.x.scale), (e.y *= r.y.scale), yi(t, r)),
      s && it(o.latestValues) && yt(t, o.latestValues));
  }
...
class ka {
  ...
  start(e, { snapToCursor: n = !1 } = {}) {
    ...
    this.panSession = new di(
      e,
      { onSessionStart: i, onStart: o, onMove: r, onSessionEnd: a, resumeAnimation: c },
      {
  ...
  updateAxis(e, n, s) {
    ...
    (this.constraints && this.constraints[e] && (r = ba(r, this.constraints[e], this.elastic[e])),
      o.set(r));
  }
  resolveConstraints() {
    var e;
    ...
    (n && mt(n)
      ...
      : n && i
        ? (this.constraints = Va(i.layoutBox, n))
        : (this.constraints = !1),
      (this.elastic = wa(s)),
      o !== this.constraints &&
        i &&
        ...
        W((r) => {
          this.getAxisMotionValue(r) &&
            (this.constraints[r] = Aa(i.layoutBox[r], this.constraints[r]));
        }));
  }
  resolveRefConstraints() {
    ...
    const o = Fa(s, i.root, this.visualElement.getTransformPagePoint());
    let r = Sa(i.layout.layoutBox, o);
    if (n) {
      const a = n(Da(r));
  ...
  scalePositionWithinConstraints() {
    ...
    W((r) => {
      ...
      if (a) {
        const c = a.get();
        i[r] = Ca({ min: c, max: c }, this.constraints[r]);
      }
    });
...
function Pi(t) {
  const [e, n] = Ua(),
    s = y.useContext(Oe);
  return us.createElement(Wa, {
    ...t,
    layoutGroup: s,
    switchLayoutGroup: y.useContext(ps),
    isPresent: e,
    safeToRemove: n,
  });
}
const Ga = {
  ...
  Wn = (t) => typeof t == 'number' || b.test(t);
function $a(t, e, n, s, i, o) {
  i
    ? ((t.opacity = R(0, n.opacity !== void 0 ? n.opacity : 1, za(s))),
      (t.opacityExit = R(e.opacity !== void 0 ? e.opacity : 1, 0, Ka(s))))
    : o &&
      (t.opacity = R(
  ...
  for (let r = 0; r < Ha; r++) {
    ...
    (c || (c = 0),
      l || (l = 0),
      c === 0 || l === 0 || Wn(c) === Wn(l)
        ? ((t[a] = Math.max(R(Nn(c), Nn(l), s), 0)), (H.test(l) || H.test(c)) && (t[a] += '%'))
        : (t[a] = l));
  }
...
function _a(t, e = 0, n = 1, s = 0.5, i, o = t, r = t) {
  if (
  ...
  (t === o && (a -= e), (t.min = $n(t.min, e, n, a, i)), (t.max = $n(t.max, e, n, a, i)));
}
function zn(t, e, [n, s, i], o, r) {
  _a(t, e[n], e[s], e[i], e.scale, o, r);
}
const Xa = ['x', 'scaleX', 'originX'],
  Ya = ['y', 'scaleY', 'originY'];
function Kn(t, e, n, s) {
  (zn(t.x, e, Xa, n ? n.x : void 0, s ? s.x : void 0),
    zn(t.y, e, Ya, n ? n.y : void 0, s ? s.y : void 0));
}
function _n(t) {
...
function Ci({
  ...
  return class {
    constructor(r = {}, a = e?.()) {
      ((this.id = rc++),
        ...
        (this.updateProjection = () => {
          ((this.projectionUpdateScheduled = !1),
            (rt.totalNodes = rt.resolvedTargetDeltas = rt.recalculatedProjection = 0),
      ...
      this.root === this && (this.nodes = new Ja());
    }
    ...
    mount(r, a = this.root.hasTreeAnimated) {
      ...
      ((this.isSVG = nc(r)), (this.instance = r));
        ...
        t(r, () => {
          ((this.root.updateBlockedByResize = !0),
            ...
            Ht.hasAnimatedSinceResize &&
              ((Ht.hasAnimatedSinceResize = !1), this.nodes.forEach(Jn)));
        });
      }
        ...
        this.options.animate !== !1 &&
          ...
          this.addEventListener(
            ...
            ({ delta: h, hasLayoutChanged: f, hasRelativeTargetChanged: d, layout: m }) => {
              ...
              const p = this.options.transition || u.getDefaultTransition() || xc,
                { onLayoutAnimationStart: x, onLayoutAnimationComplete: T } = u.getProps(),
                v = !this.targetLayout || !Si(this.targetLayout, m) || d,
                g = !f && d;
              if (
    ...
    update() {
      ...
      (this.isUpdating || this.nodes.forEach(hc),
        (this.isUpdating = !1),
      ...
      ((B.delta = J(0, 1e3 / 60, a - B.timestamp)),
        (B.timestamp = a),
        (B.isProcessing = !0),
        ae.update.process(B),
    ...
    applyTransform(r, a = !1) {
      ...
      for (let l = 0; l < this.path.length; l++) {
        ...
        (!a &&
          ...
          it(u.latestValues) && yt(c, u.latestValues));
      }
      return (it(this.latestValues) && yt(c, this.latestValues), c);
    }
    removeTransform(r) {
      const a = E();
      N(a, r);
      for (let c = 0; c < this.path.length; c++) {
        const l = this.path[c];
        if (!l.instance || !it(l.latestValues)) continue;
        Me(l.latestValues) && l.updateSnapshot();
        const u = E(),
          h = l.measurePageBox();
        (N(u, h), Kn(a, l.latestValues, l.snapshot ? l.snapshot.layoutBox : void 0, u));
      }
      return (it(this.latestValues) && Kn(a, this.latestValues), a);
    }
    setTargetDelta(r) {
    ...
    resolveTargetDelta(r = !1) {
      ...
      if (!(!this.layout || !(h || f))) {
        if (
          ((this.resolvedRelativeTargetAt = B.timestamp), !this.targetDelta && !this.relativeTarget)
        ) {
          ...
          d && d.layout && this.animationProgress !== 1
            ? ((this.relativeParent = d),
              ...
              Mt(this.relativeTargetOrigin, this.layout.layoutBox, d.layout.layoutBox),
        ...
        if (!(!this.relativeTarget && !this.targetDelta)) {
          if (
            ...
            this.relativeParent.target
              ? (this.forceRelativeParentToResolveTarget(),
                Ta(this.target, this.relativeTarget, this.relativeParent.target))
              : this.targetDelta
                ? (this.resumingFrom
    ...
    getClosestProjectingParent() {
      if (!(!this.parent || Me(this.parent.latestValues) || gi(this.parent.latestValues)))
    ...
    calcProjection() {
      ...
      const f = this.treeScale.x,
        d = this.treeScale.y;
      (Ra(this.layoutCorrected, this.treeScale, this.path, c),
        a.layout &&
          !a.target &&
      ...
      (Dt(this.projectionDelta, this.layoutCorrected, m, this.latestValues),
        ...
        (this.projectionTransform !== p || this.treeScale.x !== f || this.treeScale.y !== d) &&
          ((this.hasProjected = !0),
          this.scheduleRender(),
    ...
    setAnimationOrigin(r, a = !1) {
      ...
      const f = E(),
        ...
        v = !!(p && !T && this.options.crossfade === !0 && !this.path.some(vc));
      this.animationProgress = 0;
      let g;
      ((this.mixTargetDelta = (P) => {
        ...
        (ts(h.x, r.x, V),
          ...
          this.relativeTarget &&
            ...
            yc(this.relativeTarget, this.relativeTargetOrigin, f, V),
            g && qa(this.relativeTarget, g) && (this.isProjectionDirty = !1),
            g || (g = E()),
            N(g, this.relativeTarget)),
          p && ((this.animationValues = u), $a(u, l, this.latestValues, V, v, T)),
    ...
    finishAnimation() {
      (this.currentAnimation &&
        (this.mixTargetDelta && this.mixTargetDelta(Zn), this.currentAnimation.stop()),
    ...
    applyTransformsToTarget() {
      ...
      if (!(!a || !c || !l)) {
        ...
        (N(a, c), yt(a, u), Dt(this.projectionDeltaWithTransform, this.layoutCorrected, a, u));
      }
    }
    ...
    getProjectionStyles(r) {
      ...
      (this.applyTransformsToTarget(),
        (l.transform = Yn(this.projectionDeltaWithTransform, this.treeScale, f)),
      ...
      for (const p in $t) {
        ...
        const { correct: x, applyTo: T } = $t[p],
          v = l.transform === 'none' ? f[p] : x(f[p], h);
        if (T) {
          const g = T.length;
...
function ac(t) {
  ...
  if (t.isLead() && t.layout && n && t.hasListeners('didUpdate')) {
    ...
    Dt(a, s, n.layoutBox);
    const c = gt();
    r ? Dt(c, t.applyTransform(i, !0), n.measuredBox) : Dt(c, s, n.layoutBox);
    const l = !Vi(a);
    let u = !1;
    if (!t.resumeFrom) {
...
const xc = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
  ns = (t) => typeof navigator < 'u' && navigator.userAgent.toLowerCase().includes(t),
  ss = ns('applewebkit/') && !ns('chrome/') ? Math.round : L;
function is(t) {
...
function Ai(t, e, n) {
  return t === 'position' || (t === 'preserve-aspect' && !we(Xn(e), Xn(n), 0.2));
}
const Tc = Ci({
  ...
  bc = { pan: { Feature: Ia }, drag: { Feature: Oa, ProjectionNode: wi, MeasureLayout: Pi } },
...
const Lc = (t, e, n) => {
  ...
  Ec = (t, e, n = {}, s = {}) => {
    ((e = { ...e }), (s = { ...s }));
    const i = Object.keys(e).filter(Di);
    let o = [],
      r = !1;
    const a = [];
    if (
      (i.forEach((c) => {
        ...
        if (Kt(f)) {
          const m = f.length,
            p = f[0] === null ? 1 : 0;
          ((u = f[p]), (h = Vt(u)));
          for (let x = p; x < m && f[x] !== null; x++) d ? ze(Vt(f[x]) === d) : (d = Vt(f[x]));
        } else d = Vt(f);
        if (h !== d)
          if (rs(h) && rs(d)) {
            const m = l.get();
            (typeof m == 'string' && l.set(parseFloat(m)),
              typeof f == 'string'
                ? (e[c] = parseFloat(f))
                : Array.isArray(f) && d === b && (e[c] = f.map(parseFloat)));
          } else
      ...
      return (
        ...
        t.render(),
        te && c !== null && window.scrollTo({ top: c }),
        { target: l, transitionEnd: s }
      );
    } else return { target: e, transitionEnd: s };
  };
function Fc(t, e, n, s) {
  return wc(e) ? Ec(t, e, n, s) : { target: e, transitionEnd: s };
}
const Bc = (t, e, n, s) => {
    const i = Cc(t, e, s);
    return ((e = i.target), (s = i.transitionEnd), Fc(t, e, n, s));
  },
  Ee = { current: null },
  Mi = { current: !1 };
function kc() {
...
class Uc {
  ...
  loadFeatures({ children: e, ...n }, s, i, o) {
    ...
    for (let c = 0; c < Oc; c++) {
      const l = Ri[c],
        { isEnabled: u, Feature: h, ProjectionNode: f, MeasureLayout: d } = Lt[l];
      (f && (r = f),
...
class Gc extends Li {
  ...
  readValueFromInstance(e, n) {
    ...
    return ((n = Cs.has(n) ? n : Be(n)), e.getAttribute(n));
  }
...
const Hc = (t, e) =>
    Ie(t)
      ? new Gc(e, { enableHardwareAcceleration: !1 })
      : new Wc(e, { enableHardwareAcceleration: !0 }),
  $c = { layout: { ProjectionNode: wi, MeasureLayout: Pi } },
  zc = { ...ya, ...jr, ...bc, ...$c },
  rl = zi((t, e) => Vr(t, e, zc, Hc));
function Ei() {
  const t = y.useRef(!1);
  return (
    Fe(
...
function Xc({ children: t, isPresent: e }) {
  ...
  return (
    ...
    y.createElement(_c, { isPresent: e, childRef: s, sizeRef: i }, y.cloneElement(t, { ref: s }))
  );
}
const xe = ({
  children: t,
  ...
  return (
    ...
    r === 'popLayout' && (t = y.createElement(Xc, { isPresent: n }, t)),
    y.createElement(Jt.Provider, { value: l }, t)
  );
};
function Yc() {
  return new Map();
...
const ol = ({
  ...
  const a = y.useContext(Oe).forceRender || Kc()[0],
    c = Ei(),
    l = Qc(t);
  let u = l;
  ...
  return (
    ...
    (u = u.map((v) => {
      ...
      return h.has(g)
        ? v
        : y.createElement(xe, { key: ot(v), isPresent: !0, presenceAffectsLayout: o, mode: r }, v);
    })),
    y.createElement(y.Fragment, null, h.size ? u : u.map((v) => y.cloneElement(v)))
  );
};
function Jc(t, e, n) {
  return (
...
function el(t, e, { root: n, margin: s, amount: i = 'some' } = {}) {
  const o = Jc(t),
    r = new WeakMap(),
    a = (l) => {
      l.forEach((u) => {
        ...
        if (u.isIntersecting !== !!h)
          if (u.isIntersecting) {
            const f = e(u);
            typeof f == 'function' ? r.set(u.target, f) : c.unobserve(u.target);
          } else h && (h(u), r.delete(u.target));
      });
    },
    c = new IntersectionObserver(a, {
      root: n,
      rootMargin: s,
      threshold: typeof i == 'number' ? i : tl[i],
    });
  return (o.forEach((l) => c.observe(l)), () => c.disconnect());
}
function al(t, { root: e, margin: n, amount: s, once: i = !1 } = {}) {
  ...
  return (
    y.useEffect(() => {
      ...
      return el(t.current, a, c);
    }, [e, t, n, i, s]),
    o
  );
}
export { ol as A, us as R, rl as m, y as r, al as u };
//# sourceMappingURL=ui-Bz53u27h.js.map
